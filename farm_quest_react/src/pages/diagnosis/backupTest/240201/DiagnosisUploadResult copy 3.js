                            ...
                            <section className="diagnosis_result_yolo_analystic_wrap">
                                ...
                                <article className="diagnosis_result_detect_wrap">
                                    {Object.keys(serialized_results.boxes).map((boxKey, index) => {
                                        ...
                                        // console.log('decodedLabelName', decodedLabelName)                                    
                                        
                                        const url_crops = save_file_name && index > 0 ? 
                                        // `http://127.0.0.1:8000/media/diagnosis/yolo/origin_img/result_img/${decodedFileName}/crops/${decodedLabelName}/${decodedFileName}${index}.jpg` : 
                                        // `http://127.0.0.1:8000/media/diagnosis/yolo/origin_img/result_img/${decodedFileName}/crops/${decodedLabelName}/${decodedFileName}.jpg`;
                                        // `http://127.0.0.1:8000/media/diagnosis/yolo/origin_img/result_img/${file_name}/crops/${labelName}/${file_name}${index}.jpg` :
                                        `http://127.0.0.1:8000/media/diagnosis/yolo/origin_img/result_img/${file_name}/crops/${labelName}/${file_name}.jpg` : null ;
