                        ...
                        {recommendations.map((recommend, index) => (
                            <div key={index} className="diagnosis_recommend_section_2_content_1_1">
                                <div className="diagnosis_recommend_section_2_content_1_1_1">
                                    <img className="diagnosis_recommend_section_2_content_1_1_1_1"
                                        src={recommend.shoping_tb_rss_channel_item_image}
                                        alt={recommend.shoping_tb_rss_channel_item_title}
                                    />
                                </div>
                                <div className="diagnosis_recommend_section_2_content_1_2">
                                    <div className="diagnosis_recommend_section_2_content_1_2">
                                        <div className="diagnosis_recommend_section_2_content_1_2_1">{recommend.shoping_tb_rss_channel_item_title}</div>
                                        <div className="diagnosis_recommend_section_2_content_1_2_2">{recommend.shoping_tb_rss_channel_item_lprice} 원</div>
                                    </div>
                                </div>
                            </div>
                        ))}
